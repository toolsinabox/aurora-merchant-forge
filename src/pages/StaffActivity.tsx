    ...
    <AdminLayout>
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-4 gap-3">
          ...
          <Card><CardContent className="p-4">
            <div className="flex items-center gap-2"><Shield className="h-4 w-4 text-muted-foreground" /><div><p className="text-lg font-bold">{Math.round(totalActions / Math.max((members as any[]).length, 1))}</p><p className="text-[10px] text-muted-foreground">Avg Actions/User</p></div></div>
          </CardContent></Card>
        </div>
