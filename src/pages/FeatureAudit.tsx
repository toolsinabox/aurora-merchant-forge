...
const featureData: FeatureCategory[] = [
  ...
  // ═══════ 40. THIRD-PARTY INTEGRATIONS ═══════
  {
    ...
    features: [
      ...
      { name: "Mailchimp", description: "Email marketing list sync", status: "done", notes: "mailchimp-sync edge function with sync_customers (batch upserts customers with merge fields, tags) and sync_newsletter (syncs newsletter_subscribers with subscribe/unsubscribe status); config on Integrations page" },
      { name: "Klaviyo", description: "Advanced email marketing sync", status: "done", notes: "klaviyo-sync edge function with sync_profiles (upserts customer profiles with properties), track_event (custom event tracking), track_order (Placed Order event with line items and value); config on Integrations page" },
      ...
      { name: "Zapier Integration", description: "Connect to 5000+ apps via Zapier", status: "done", notes: "webhook-dispatcher edge function dispatches events to Zapier webhook URLs with event payload (event type, store_id, timestamp, data); config on Integrations page" },
      { name: "Make (Integromat)", description: "Workflow automation via Make", status: "done", notes: "webhook-dispatcher edge function dispatches events to Make webhook URLs alongside Zapier and registered webhooks; HMAC signing for registered webhooks; config on Integrations page" },
