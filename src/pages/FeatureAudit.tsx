...
const b2bWholesaleDeepFeatures: FeatureCategory[] = [
  {
    ...
    features: [
      ...
      { name: "Net Payment Terms (Net-30/60/90)", description: "Allow wholesale customers to pay on terms", status: "not_started" },
      { name: "Credit Limit per Customer", description: "Set maximum outstanding credit per wholesale account", status: "not_started" },
      ...
      { name: "CSV Order Upload", description: "Upload CSV of SKU/quantity pairs to create order", status: "not_started" },
      { name: "Reorder from Previous Order", description: "One-click reorder of previous order items", status: "partial" },
      { name: "Sales Rep Assignment", description: "Assign sales reps to wholesale accounts", status: "not_started" },
      ...
      { name: "Tax Exemption Certificate Upload", description: "Allow B2B customers to upload tax exemption docs", status: "not_started" },
...
const reportingDeepFeatures: FeatureCategory[] = [
  {
    ...
    features: [
      ...
      { name: "ABC Analysis (Inventory)", description: "Classify products by revenue contribution (A/B/C tiers)", status: "not_started" },
      { name: "Dead Stock Report", description: "Products with zero sales in configurable period", status: "not_started" },
      { name: "Customer Lifetime Value (CLV)", description: "Calculate and display customer LTV", status: "partial", notes: "total_spent tracked" },
      { name: "Customer Cohort Analysis", description: "Retention and spend analysis by signup cohort", status: "not_started" },
      ...
      { name: "Sales by Channel Report", description: "Revenue breakdown by sales channel (web, POS, marketplace)", status: "not_started" },
      ...
      { name: "Tax Report / BAS Report", description: "Tax collected summary for BAS/GST reporting", status: "not_started" },
...
const emailAutomationDeepFeatures: FeatureCategory[] = [
  {
    ...
    features: [
      ...
      { name: "Win-Back Campaign", description: "Re-engage inactive customers after configurable period", status: "not_started" },
      { name: "Birthday/Anniversary Email", description: "Automated email on customer birthday with offer", status: "not_started" },
...
const adminUxFeatures: FeatureCategory[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { name: "New Customer Signup Alert", description: "Notification when new customer registers", status: "not_started" },
      { name: "New Review Alert", description: "Alert when new product review is submitted", status: "not_started" },
...
const seoContentDeepFeatures: FeatureCategory[] = [
  {
    ...
    features: [
      ...
      { name: "Heading Hierarchy Check", description: "Validate H1-H6 hierarchy on content pages", status: "not_started" },
      ...
      { name: "Content Versioning", description: "Track and restore previous versions of content", status: "not_started" },
