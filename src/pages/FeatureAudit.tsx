...
const featureData: FeatureCategory[] = [
  ...
  // ═══════ 6. INVENTORY / STOCK CONTROL ═══════
  {
    ...
    features: [
      ...
      { name: "Serial Number Tracking", description: "Track individual units by serial number", status: "partial", notes: "Batch/lot tracking provides foundation; per-unit serial tracking needs dedicated serial_numbers table" },
