...
const warehouseDeepFeatures: FeatureCategory[] = [
  {
    ...
    features: [
      ...
      { name: "Shipping Label Auto-Print", description: "Auto-generate and print carrier label at pack station", status: "partial", notes: "Packing slip auto-print implemented; carrier label requires carrier API integration" },
