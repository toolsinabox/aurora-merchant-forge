...
const featureData: FeatureCategory[] = [
  ...
  // ═══════ 26. MARKETPLACE INTEGRATIONS ═══════
  {
    ...
    features: [
      { name: "eBay Listing Sync", description: "Publish products to eBay and sync orders/stock", status: "done", notes: "ebay-sync edge function with list_products action: creates/updates eBay inventory items via Sell API with product title, description, brand, images, stock; requires eBay developer credentials in Integrations config" },
      { name: "eBay Order Import", description: "Import eBay orders into platform", status: "done", notes: "ebay-sync edge function with import_orders action: fetches orders from eBay Fulfillment API, creates customers and orders with EBAY- prefix, imports line items with SKU matching, sets order_channel=ebay" },
      { name: "eBay Stock Sync", description: "Real-time stock sync between platform and eBay", status: "done", notes: "ebay-sync edge function with sync_stock action: updates eBay inventory item quantities for all active products with SKUs" },
      { name: "eBay Category Mapping", description: "Map product categories to eBay categories", status: "partial", notes: "eBay connection configured; category mapping requires eBay Taxonomy API integration for category tree fetching" },
      { name: "Amazon Integration", description: "List products on Amazon marketplace", status: "partial", notes: "Connection config UI on Integrations page; listing sync edge function not yet built (requires Amazon SP-API)" },
      { name: "Amazon Order Import", description: "Import Amazon orders", status: "partial", notes: "Connection config on Integrations page; order import edge function not yet built (requires Amazon SP-API)" },
      ...
      { name: "Facebook / Instagram Shop", description: "Sync catalog to Facebook/Instagram Shop", status: "partial", notes: "Connection config UI on Integrations page; catalog sync requires Meta Commerce API integration" },
      { name: "Catch.com.au Integration", description: "Australian marketplace integration", status: "partial", notes: "Connection config UI on Integrations page; listing sync requires Catch API credentials" },
      { name: "Kogan Integration", description: "Kogan marketplace listing and sync", status: "partial", notes: "Connection config UI on Integrations page; listing sync requires Kogan API credentials" },
      { name: "TradeMe Integration", description: "NZ marketplace integration", status: "partial", notes: "Connection config UI on Integrations page; listing sync requires TradeMe developer credentials" },
      { name: "MyDeal Integration", description: "MyDeal marketplace listing", status: "partial", notes: "Connection config UI on Integrations page; listing sync requires MyDeal API credentials" },
    ],
  },
