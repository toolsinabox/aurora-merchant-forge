...
const featureData: FeatureCategory[] = [
  ...
  // ═══════ 16. SHIPPING ═══════
  {
    ...
    features: [
      ...
      { name: "Real-Time Carrier Rates (Australia Post)", description: "Live rates from Australia Post API", status: "done", notes: "carrier-rates edge function fetches live rates from Australia Post PAC API with postcode/dimensions/weight; config on Integrations page" },
      { name: "Real-Time Carrier Rates (Sendle)", description: "Live rates from Sendle courier API", status: "done", notes: "carrier-rates edge function fetches quotes from Sendle API with suburb/postcode/weight; config on Integrations page" },
      { name: "Real-Time Carrier Rates (StarTrack)", description: "Live rates from StarTrack", status: "done", notes: "carrier-rates edge function fetches StarTrack rates via Australia Post infrastructure; config on Integrations page" },
      { name: "Real-Time Carrier Rates (Fastway/Aramex)", description: "Live courier rates from Aramex/Fastway", status: "done", notes: "carrier-rates edge function fetches Aramex/Fastway rates via PSC lookup API; config on Integrations page" },
      { name: "Real-Time Carrier Rates (UPS/FedEx/DHL)", description: "International carrier rate integration", status: "done", notes: "carrier-rates edge function with UPS Rating API integration and FedEx/DHL support; config on Integrations page" },
  ...
  // ═══════ 40. THIRD-PARTY INTEGRATIONS ═══════
  {
    ...
    features: [
      ...
      { name: "Starshipit", description: "AU/NZ shipping automation", status: "done", notes: "starshipit-sync edge function with export_orders (pushes orders with destination/items), get_rates (shipping quotes), import_tracking (fetches shipped orders, upserts shipments), create_label (generates shipping label); config on Integrations page" },
